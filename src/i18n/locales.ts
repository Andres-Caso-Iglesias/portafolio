...
export const locales: LocalesMap = {
  es: {
    home: {
      ...
      contactIntro: 'Buscando una oportunidad como Backend Developer (España, híbrido o remoto).',
      resume: 'Resumen',
      github: 'GitHub',
      linkedin: 'LinkedIn',
      viewGithub: 'Ver en GitHub',
      timelineTitle: 'Mi Trayectoria',
      seoTitle: 'Andrés Caso Iglesias | Backend Developer',
      seoDescription: 'Portfolio de Andrés Caso Iglesias - Backend Developer especializado en C#/.NET, Java y TypeScript',
    },
  },
  en: {
    home: {
      ...
      contactIntro: 'Seeking an opportunity as a Backend Developer (Spain, hybrid or remote).',
      resume: 'Resume',
      github: 'GitHub',
      linkedin: 'LinkedIn',
      ...
      seoTitle: 'Andrés Caso Iglesias | Backend Developer',
      seoDescription: 'Portfolio of Andrés Caso Iglesias - Backend Developer specialized in C#/.NET, Java and TypeScript',
    },
  },
}
