...
export const locales: LocalesMap = {
  es: {
    home: {
      ...
      profileIntroFull: 'Después de casi 20 años liderando equipos en hostelería y logística, di un giro radical hacia el desarrollo de software. Como no soy una IA no voy a decir que programar me apasiona, pero siempre me ha fascinado entender como funcionaban las cosas por dentro. Y por si no lo dejo claro mas adelante soy bilingüe nativo español-inglés.',
  ...
  en: {
    home: {
      ...
      profileIntroFull: 'After almost 20 years leading teams in hospitality and logistics, I pivoted to software development. As I am not an AI, I won\'t claim that coding excites me, but I have always been fascinated by understanding how things work inside. And to be clear later, I am bilingual native Spanish-English.',
