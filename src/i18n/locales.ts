...
export const locales: LocalesMap = {
  ...
  en: {
    home: {
      ...
      profileIntroFull: 'After almost 20 years leading teams in hospitality and logistics, I pivoted to software development.\n \nAs I am not an AI, I won\'t claim that coding excites me, but I have always been fascinated by understanding how things work inside.\n\nAnd to be clear later, I am bilingual native Spanish-English.',
