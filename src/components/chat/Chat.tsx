      ...
      >
        {isOpen ? (
          ...
          >
            <path
              fillRule="evenodd"
              d="M4.804 21.644A6.707 6.707 0 006 21.75a6.721 6.721 0 003.583-1.029c.428.053.856.087 1.283.087 3.766 0 6.834-3.098 6.834-6.911 0-3.813-3.068-6.911-6.834-6.911-.428 0-.856.034-1.283.087A6.707 6.707 0 003 5.25c0 1.054.306 2.04.804 2.871C2.588 9.103 1.5 11.439 1.5 14c0 3.866 3.134 7 7 7 .854 0 1.676-.152 2.434-.436A6.693 6.693 0 0014.25 21c1.517 0 2.947-.467 4.125-1.268.22.637.325 1.31.325 2.014a6.707 6.707 0 01-4.804 2.476z"
              clipRule="evenodd"
            />
          </svg>
        )}
