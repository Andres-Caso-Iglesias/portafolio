...
export const testingResponse: ChatResponse = {
  id: 'testing',
  keywords: [
    // Español - específicos
    'testing unitario experiencia',
    'jest vitest experiencia',
    'playwright e2e experiencia',
    'tdd bdd experiencia',
    'cobertura código tests',
    'testing integración',
    // Inglés
    'unit testing experience',
    'jest vitest experience',
    'playwright e2e experience',
    'tdd bdd experience',
    'code coverage tests',
    'integration testing',
  ],
