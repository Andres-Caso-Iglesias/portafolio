...
export const frameworksResponse: ChatResponse = {
  id: 'frameworks',
  keywords: [
    // Español - específicos
    'nextjs react angular experiencia',
    'nestjs springboot net experiencia',
    'frameworks frontend backend',
    'arquitectura limpia frameworks',
    // Inglés
    'nextjs react angular experience',
    'nestjs springboot net experience',
