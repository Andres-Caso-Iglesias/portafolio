...
try {
  ...
  assert.ok(t('es', 'home.profileIntro').length > 0, 'es home.profileIntro must exist for SEO');
  assert.ok(t('en', 'home.profileIntro').length > 0, 'en home.profileIntro must exist for SEO');
